      ...
      <div class="space-y-2">
        ...
        <div class="space-y-2">
          <label class="flex items-center">
            ...
            />
            <span class="ml-2  text-gray-900 dark:text-gray-100">Filtra per Codice o Cognome</span>
          </label>
          <label class="flex items-center">
            <input
              v-model="filtroTipo"
              ...
              class="h-4 w-4 text-primary focus:ring-primary border-gray-300 dark:border-gray-600"
            />
            <span class="ml-2  text-gray-900 dark:text-gray-100">Selezione un intervallo di dipendenti</span>
          </label>
        </div>
      </div>
    </div>
