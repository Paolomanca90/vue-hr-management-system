<template>
  <div class="space-y-4">
    ...
    <div class="flex items-center gap-4">
      <label class="text-sm font-medium w-20">Azienda:</label>
      <div v-if="isEditMode" class="text-sm font-medium">
        {{ companyDisplayText }}
      </div>
    ...
    <div class="space-y-3">
      ...
      <div class="flex items-center gap-4">
        <label :for="field1Id" class="text-sm font-medium text-gray-700 w-20">
          {{ field1Label }}
        </label>
        <input
          :id="field1Id"
      ...
      <div v-if="showField2" class="flex items-center gap-4">
        <label :for="field2Id" class="text-sm font-medium text-gray-700 w-20">
          {{ field2Label }}
        </label>
        <input
          :id="field2Id"
      ...
      <div v-if="showField3" class="flex items-center gap-4">
        <label :for="field3Id" class="text-sm font-medium text-gray-700 w-20">
          {{ field3Label }}
        </label>
        <input
          :id="field3Id"
...
const props = withDefaults(defineProps<Props>(), {
  ...
  field1Required: true,
  field1Classes: 'rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary sm:text-sm p-1',
  field1Id: 'field1',
  ...
  field2Classes: 'rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary sm:text-sm p-1',
  field2Id: 'field2',
  ...
  field3Classes: 'rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary sm:text-sm p-1',
  field3Id: 'field3'
})
