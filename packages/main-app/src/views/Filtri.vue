...
<template>
  <div class="space-y-3">
    ...
    >
      <template #actions>
        <button class="max-md:w-full max-md:block btn btn-primary btn-sm text-xs text-white" @click="addNewFiltro">
          <FaIcon icon="plus" class="mr-2"/>
          Nuovo Filtro
        </button>
        <button class="max-md:w-full max-md:block btn btn-primary btn-outline btn-sm text-xs" @click="refreshFiltri">
          ...
          <template #toolbar>
            <div class="dropdown dropdown-end">
              ...
              <ul tabindex="0"  class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-60 z-[100]">
                ...
                <li><a @click="importFiltri"><FaIcon icon="upload" class="mr-2 text-xs" />Importa Filtri</a></li>
              </ul>
            </div>
          </template>
