...
<template>
  <div class="space-y-3">
    ...
    >
      <template #actions>
        <button class="max-md:w-full max-md:block btn btn-primary btn-sm text-xs text-white" @click="addNewSede">
          ...
          <template #toolbar>
            <div class="dropdown dropdown-end">
              ...
              <ul tabindex="0"  class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-60 z-[100]">
                ...
                <li><a @click="importSedi"><FaIcon icon="upload" class="mr-2 text-xs" />Importa Sedi</a></li>
              </ul>
            </div>
          </template>
